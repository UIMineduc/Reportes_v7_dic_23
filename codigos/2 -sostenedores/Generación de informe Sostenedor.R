...
colnames(bd_desvinc_intran_r)
 ...
 bd <- bd %>% mutate(gen_alu_2022r = case_when(gen_alu_2022r == 1 ~ "M", gen_alu_2022r == 2 ~ "F", gen_alu_2022r == 0 ~ "", gen_alu_2022r == "I" ~ ""))
...
tbl_asis_ee <- xsl_asis_ee %>% select(rut_sost_rbd2022, rbd, nom_rbd, nom_com_rbd, asis_marzo, 
  ...
  rutsost1 <- ruts_sost[1:1178] #[1:1178]  #[1179:2356]   [2357:3534]   #[3535:4716]
  ...
  archivos <- list.files("Outputs/sostenedores")
...
#### Ejecucion de Loop ----
  ...
  rutsost1 <- ruts_sost[3535:4716] #[1:1178]  #[1179:2356]   [2357:3534]   #[3535:4716]
  errores <- c(65065400,65538990,65102264,70007030,70017110,
               70042001,70067400,70308800,70350200,70357600,
               72732100,81679000,82991800,65232280,70589000)
  
 errores2 <-  65115452
 
 aux <- intersect(rutsost1,errores)
 length(aux)
 length(errores)
  
for(rut_sost in errores2){     #rutsost1 #c(42,53,101,136,134)
  try({
        tic()
        #**************************************************************************************************************************/
        ## 3.1 PRE RENDER  ----------------------------------------------------------------
        ...
        desvinc <- desvinc %>% select("run_alu2", "nom_alu2022", "app_alu2022", "apm_alu2022", "gen_alu_2022r", "edad_alu_2022r", "nom_grado", "prom_gral2022", "asistencia2022", "sit_fin_r_2022r", 
        ...
        desvinc2 <- desvinc2 %>% select("run_alu2_ret", "nom_alu_ret", "app_alu_ret", "apm_alu_ret", "gen_alu_ret", "edad_alu_ret", "nom_grado_ret", "fec_ret_rbd_ret", "valid_estud",
        ...
        desvinc3 <- desvinc3 %>% select("run_alu2", "nom_alu", "app_alu", "apm_alu", "gen_alu", "edad_alu","nom_grado", "sit_fin_r", "rbd", "nom_rbd", "cod_depe2", "cod_reg_rbd", "nom_com_rbd", "cert_val_21", "cert_val_22", "insc_val_23") # cert vald 21? muchos vacios
        ...
        url_sin_fin_g = paste0(getwd(),"/Img temp/",rut_sost,"_sit_fin_g.png")
      ...
      url_cur_desv_g = paste0(getwd(),"/Img temp/",rut_sost,"_cur_desv_g.png")
      ...
      url_cur_desv_g_2 = paste0(getwd(),"/Img temp/",rut_sost,"_cur_desv_g_2.png")
      ...
      url_asis_crit_g = paste0(getwd(),"/Img temp/", rut_sost,"_asis_crit_g.png")
      ...
      url_sost_desv_g = paste0(getwd(),"/Img temp/", rut_sost,"_sost_desv_g.png")
      ...
      url_sost_desv_g_2 = paste0(getwd(),"/Img temp/", rut_sost,"_sost_desv_g_2.png")
      ...
      url_sost_asist_g = paste0(getwd(),"/Img temp/", rut_sost,"_sost_asist_g.png")
      ...
      url_sost_asisgrave_g = paste0(getwd(),"/Img temp/", rut_sost,"_sost_asisgrave_g.png")
      ...
      # #**************************************************************************************************************************/
      #
      rmarkdown::render("Codigos/sostenedores/RMKD Informe Sostenedor.Rmd",
                        ...
                        output_file = paste0("Outputs/sostendores dup/", rut_sost, ".pdf"))
  ...
  desvinc0 <- desvinc %>% select("rbd_2022r", "nom_rbd_2022r", "run_alu2", "nom_alu2022", "app_alu2022", "apm_alu2022", "nom_grado", "edad_alu_2022r", "gen_alu_2022r", "sit_fin_r_2022r", "cert_val_22", "valid_estud")
  colnames(desvinc0) <- c("RBD", "Nombre Establecimiento", "RUN", "Nombre", "Apellido Parteno", "Apellido Materno", "Grado en 2022", "Edad 2022", "Sexo", "Situación final 2022", "Validó estudios en 2022", "Inscrita/o para examen de validación 2023")
  
  desvinc2_0 <- desvinc2 %>% select("rbd_ret", "nom_rbd_ret", "run_alu2_ret", "nom_alu_ret", "app_alu_ret", "apm_alu_ret", "nom_grado_ret", "edad_alu_ret", "gen_alu_ret", "fec_ret_rbd_ret", "valid_estud")
  colnames(desvinc2_0) <- c("RBD", "Nombre Establecimiento", "RUN", "Nombre", "Apellido Parteno", "Apellido Materno","Grado en 2023", "Edad", "Sexo", "Fecha de retiro", "Inscrita/o para examen de validación 2023")
  
  desvinc3_0 <- desvinc3 %>% select("rbd", "nom_rbd", "run_alu2", "nom_alu", "app_alu", "apm_alu", "nom_grado", "edad_alu", "gen_alu", "sit_fin_r", "cert_val_21", "cert_val_22", "insc_val_23")
  colnames(desvinc3_0) <- c("RBD", "Nombre Establecimiento", "RUN", "Nombre", "Apellido Parteno", "Apellido Materno", "Grado en 2021", "Edad 2021", "Sexo", "Situación final 2021", "Validó estudios en 2021", "Validó estudios en 2022", "Inscrita/o para examen de validación 2023")
  ...
  addStyle(wb, "Resumen asist x RBD", style=pct, cols=c(5:11, 14, 20:24), rows=2:(nrow(xsl_asis_ee_deprov)+1), gridExpand=TRUE)
  addStyle(wb, "Resumen asist x RBD y grado", style=pct, cols=c(6:12, 15, 21:25), rows=2:(nrow(xsl_asis_ee_cur_deprov)+1), gridExpand=TRUE)
  
  saveWorkbook(wb, paste0("Outputs/sostendores dup/", rut_sost, ".xlsx"), overwrite = T)
