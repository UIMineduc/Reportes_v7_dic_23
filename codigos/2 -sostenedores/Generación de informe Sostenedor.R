...
rutsost1 <- ruts_sost[1179:2356] #[1:1178]  #[1179:2356]   [2357:3534]   #[3535:4712]
...
#Búsqueda pendientes
{
  ...
  archivos <- list.files("Outputs/Sostenedor 1")
...
for(rut_sost in rutsost1){     #rutsost1 #c(42,53,101,136,134)
  try({
    ...
    # #**************************************************************************************************************************/
    #
    rmarkdown::render("codigos/sostenedor/RMKD Informe sostenedor.Rmd",
                      ...
                      output_file = paste0("Outputs/Sostenedor 1/", rut_sost, ".pdf"))
    ...
    saveWorkbook(wb, paste0("Outputs/Sostenedor 1/", rut_sost, ".xlsx"), overwrite = T)
