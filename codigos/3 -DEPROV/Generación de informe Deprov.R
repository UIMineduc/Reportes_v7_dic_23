 ...
 try({
  {
     ...
     #*
     # Sys.setlocale("LC_ALL","Spanish")
     rmarkdown::render("Codigos/DEPROV/RMKD Informe Deprov.Rmd",
                       ...
                       output_file = paste0("Outputs/Deprov/", nom_deprov, ".pdf"))
     ...
     addStyle(wb, "Resumen asist x RBD", style=pct, cols=c(11:17, 20, 25:30), rows=2:(nrow(xsl_asis_ee_deprov)+1), gridExpand=TRUE)
     addStyle(wb, "Detalle asist x RBD y grado", style=pct, cols=c(12:18, 21, 27:31), rows=2:(nrow(xsl_asis_ee_cur_deprov)+1), gridExpand=TRUE)
     
     
     saveWorkbook(wb, paste0("Outputs/Deprov/", nom_deprov, ".xlsx"), overwrite = T)
