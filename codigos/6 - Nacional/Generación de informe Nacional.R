...
xsl_asis_ee <- xsl_asis_ee %>% select(cod_reg_rbd2022r2, cod_deprov_rbd, nom_deprov_rbd, nom_com_rbd, nombre_sost_rbd2022, rut_sost_rbd2022,
                                                    ...
                                                    asis_junio, asis_julio, asis_agosto, asis_septiembre,
                                                    #asis_octubre, asis_noviembre,
    ...
    
    {
      ...
      cod_reg <- cods_reg
       ...
       #  try({
          ...
          rmarkdown::render("Codigos/Nacional/RMKD Informe Nacional.Rmd",
                            ...
                            output_file = paste0("Outputs/Nacional", "Nacional", ".pdf"))
      ...
      addStyle(wb, "Resumen asist x RBD", style=pct, cols=c(11:14, 17, 23:28), rows=2:(nrow(xsl_asis_ee_deprov)+1), gridExpand=TRUE)
      addStyle(wb, "Detalle asist x RBD y grado", style=pct, cols=c(12:15, 18, 24:29), rows=2:(nrow(xsl_asis_ee_cur_deprov)+1), gridExpand=TRUE)
      
      wb
      saveWorkbook(wb, paste0("Outputs/Nacional/", "Nacional", ".xlsx"), overwrite = T)
